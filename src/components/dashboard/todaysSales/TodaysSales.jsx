...
function TodaysSales() {
  ...
  return (
    <div className="p-4 rounded-md bg-white shadow w-full md:max-w-[60%]">
      <div className="flex  items-center justify-between">
        <div>
          <DashboardHeading text={"Today’s Sales"} />
          <p className="text-xs opacity-60 mt-2">Sales Summery</p>
        </div>
        <button className="border border-black/10 p-1 px-4 flex items-center gap-2 rounded-md">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
        {cardData?.map((item) => <TodaysCard cardData={item}/>)}
      </div>
    </div>
  );
}
